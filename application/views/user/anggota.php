...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
              <a href="<?= base_url('anggota'); ?>"><i class="fas fa-users fa-3x text-warning"></i></a>
                    ...
                    foreach ($anggota as $a) { ?>
                        <tr>
                            ...
                            <!--<td>
                                        ...
                                        <a href="<?
                                                    ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $b['admin']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                                    </td> -->
                        </tr>
                    <?php } ?>
                </tbody>
